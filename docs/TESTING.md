...
| Confidence and materiality                 | Fresh/aging/stale/missing sources, bounded/unbounded issues, sensitivity, and materiality edges                                                                                                                                         | Stored data issues are conservatively converted to decision issues                                                                      | Confidence and blocking evidence remain visible on immutable detail                         |
